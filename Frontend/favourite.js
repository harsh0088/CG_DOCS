const constants = {
    apiBasePath: 'http://localhost:59689/api/Folder/ShowInFav/'
  }
...
//function for listing folders
  function listFolders() {
    try
    {
      ...
      create.innerHTML = '';
    fetch(`${constants.apiBasePath}`+sessionStorage.getItem("userid"), {
      method: 'GET'
    })
    ...
    folders.forEach(folder => {
     ...
     `
     <div class="folderBox">
     <div class="favIcon"><img class="favImage" src="./unfavourite.png" onclick="Unfavourite(${folderid})"></div>
...
function Unfavourite(folderId){
  var requestOptions = {
    method: 'PUT',
    redirect: 'follow'
  };

  fetch("http://localhost:59689/api/Folder/Unfavourite/"+folderId, requestOptions)
...
//function for showing sweet alert
...
function searchItem(){
  ...
  .then((folders) => {
    ...
    folders.forEach(folder => {
      ...
      `
     <div class="folderBox">
     <div class="favIcon"><img class="favImage" src="./favourite.png onclick="favourite(${folderid})"></div>
     <div class="folderbtn"><img class="folderimg" onclick ="createfiles(${folderid})" src="./folder.png" '></div>
     <div class="btnText">
       <button id="filebtn" onclick ="createfiles(${folderid})" style="text-decoration: none;border: 0px;font-weight:bold; background: none"> ${fname} </button></div>
      <div class="footerIcons">
